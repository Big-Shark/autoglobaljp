...
Entrust::routeNeedsPermission( 'admin/orders*', 'manage_cars', Redirect::to('/admin') );
Entrust::routeNeedsPermission( 'admin/cars*', 'manage_cars', Redirect::to('/admin') );
Entrust::routeNeedsPermission( 'admin/customers*', 'manage_customers', Redirect::to('/admin') );
